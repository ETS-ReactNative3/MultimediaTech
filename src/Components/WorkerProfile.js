                        ...
                        <div className="card-section">
                            ...
                            <label>Zip Code
                                <input id="zip"
                                    ...
                                    value={uZip}
                                    onChange={event => this.setState(byPropKey('uZip', event.target.value))}
                                />
                            </label>
                            <label>Type of Service
                                <input id="serviceType"
                                    ...
                                    placeholder="Service"
                                    value={serviceType}
                                    onChange={event => this.setState(byPropKey('serviceType', event.target.value))}
                                />
                            </label>
                            <label>Email
                                <input id="email"
